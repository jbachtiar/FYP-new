...
public class CartDetailsDAO {
    ...
    public static void deleteCartItem(String cartId, int qty, String productId) throws SQLException {
     ...
     public static ArrayList<CartDetails> getCartDetailsByCartId(String cartId) throws SQLException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                CartDetails cartDetail = new CartDetails(cartId, productSKU, quantity);
