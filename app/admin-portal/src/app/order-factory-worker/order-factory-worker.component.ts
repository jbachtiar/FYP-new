...
@Component({
  selector: 'app-order-factory-worker',
  templateUrl: './order-factory-worker.component.html',
  styleUrls: ['./order-factory-worker.component.css'],
  providers: [OrderService]
})

export class OrderFactoryWorkerComponent implements OnInit {
  private orders: any = {};
