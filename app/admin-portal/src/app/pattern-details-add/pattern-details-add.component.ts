...
@Component({
  selector: 'app-pattern-details-add',
  templateUrl: './pattern-details-add.component.html',
  styleUrls: ['./pattern-details-add.component.css'],
  providers: [ProductService]
})
export class PatternDetailsAddComponent implements OnInit {
  patternId: string;
  pattern: any = {};
  patternFabrics: any = {}
  patternColours: any = {}
