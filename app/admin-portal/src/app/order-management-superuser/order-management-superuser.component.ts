...
@Component({
  selector: 'app-order-management-superuser',
  templateUrl: './order-management-superuser.component.html',
  styleUrls: ['./order-management-superuser.component.css'],
  providers: [OrderService]
})

export class OrderManagementSuperuserComponent implements OnInit {
  private orders: any = {};
