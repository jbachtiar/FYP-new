...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`PRODUCT_LIST` ;

CREATE TABLE IF NOT EXISTS `mydb`.`PRODUCT_LIST` (
  `SKU` VARCHAR(100) NOT NULL,
  `PF_ID` VARCHAR(100) NULL,
  `COLOUR_ID` VARCHAR(100) NULL,
  `COLOUR_PRICE` DOUBLE NULL,
  `IMAGE_URL` VARCHAR(2000) NULL,
  INDEX `fk_PATTERN_FABRIC_has_COLOUR_COLOUR2_idx` (`COLOUR_ID` ASC),
  INDEX `fk_PATTERN_FABRIC_has_COLOUR_PATTERN_FABRIC2_idx` (`PF_ID` ASC),
  PRIMARY KEY (`SKU`),
  CONSTRAINT `fk_PATTERN_FABRIC_has_COLOUR_PATTERN_FABRIC2`
    FOREIGN KEY (`PF_ID`)
    REFERENCES `mydb`.`PATTERN_FABRIC` (`PF_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PATTERN_FABRIC_has_COLOUR_COLOUR2`
...
CREATE TABLE IF NOT EXISTS `mydb`.`PATTERN_TAG` (
  ...
  INDEX `fk_PATTERN_has_TAG_TAG1_idx` (`TAG_ID` ASC),
  INDEX `fk_PATTERN_has_TAG_PATTERN1_idx` (`PATTERN_ID` ASC),
